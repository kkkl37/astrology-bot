...
if choice == "Home":
    ...
    #         <script src="/workspaces/astrology-bot/interface/script.js"></script>
    #         </body>
    #         </html>
    #     """)

#     # Define your HTML, CSS, and JavaScript
#     html_code = """
# <head>
#   <meta charset="UTF-8">
...
#       <img class="back" src="/workspaces/astrology-bot/data/tarot_img/card_back.jpg">
...
#     # Display the HTML, CSS, and JavaScript using st.markdown
#     st.markdown(html_code, unsafe_allow_html=True)
#     st.markdown(f"<style>{css_code}</style>", unsafe_allow_html=True)
#     st.markdown(f"<script>{javascript_code}</script>", unsafe_allow_html=True)
